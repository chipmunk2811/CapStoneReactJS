...
export default function BlogHomePage() {
    return (
        <>
            <div className="elementor-element elementor-element-95cc900 elementor-widget elementor-widget-Amy_V2_Movie_Heading pt-5" data-id="95cc900" data-element_type="widget" data-widget_type="Amy_V2_Movie_Heading.default">
                <div className="elementor-widget-container">
                    <div className="amy-heading text-center has-seperator   seperator-left-full seperator-right-full seperator-2 "><header className="entry-header"><span className="seperator seperator-left" /><h2 className="title-heading"><span className="title">Event &amp; blog Cinemas</span></h2><span className="seperator seperator-right" /></header><div className="subtitle-heading"><p>This is a great space to write long text about your company.</p></div></div>		</div>
            </div>
                                ...
                                <div className="entry-item">
                                    ...
                                    <div className="entry-content">
                                        <h2 className="entry-title">
                                            Six
                                            book-to-film adaptations to get excited about this autumn</h2>
                            ...
                            <div className="col-md-6 full">
                                <div className="entry-item">
                                    ...
                                    <div className="entry-content">
                                        ...
                                        <div className="entry-summary">Sed ut perspiciatis unde omnis iste natus error sit
